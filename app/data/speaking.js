const speaking = [
  {
    ...
    talks: [
      ...
      },
      {
        ...
        status: "upcoming",
        links: [
          { label: "Event", url: "https://oredev.org/" },
        ],
        description: [
      ...
      },
      {
        ...
        status: "upcoming",
        links: [
          { label: "Event", url: "https://snartup.no/fest/program" },
        ],
        description: [
          "What truly shapes us without us even noticing? Sometimes, it’s not the hard stops that define our path, it’s the silent redirections, the invisible “no’s,” and the things no one says out loud. This talk reveals the quiet, systemic ways highly skilled immigrants are shaped - not just by the cultures they enter, but by the coded preferences that decide who gets to belong. I moved to Norway for a job, but soon my employer went bankrupt just months after I arrived. And so began nine months of searching. Nine months of being “almost chosen.” I reached final interviews again and again. Each time, I was told I was an excellent candidate. But each time, the job went to a Norwegian. Not because they were better. But because they were familiar. This isn’t a conspiracy - it’s a pattern. A silent comfort with the known. A national culture that values sameness, even when it claims to welcome diversity. And it has a cost: not just to people like me, but to innovation, creativity, and the richness of perspective that companies quietly forfeit. This talk invites audiences to consider the invisible forces: comfort and unconscious bias that shape careers and cultures more than we care to admit. And it offers a vision of what we could gain if we finally let go of our fear of difference. Because real inclusion doesn’t happen when we let people in. It happens when we let them stay whole.",
        ]
    ...
    talks: [
      {
        ...
        status: "past",
        links: [
          { label: "Event", url: "https://2025.trondheimdc.no/en/" },
        ],
        description: [
          "When it comes to banking applications, security is non-negotiable, but so is the user experience. With sensitive financial data on the line, ensuring that users interact securely with your platform is crucial.",
          "This talk will explore how UX design can be the unsung hero in protecting banking applications from security breaches. When UX and IT security work together, users are guided safely through complex security features without frustration or error. By focusing on intuitive design, we can reduce risky behaviors like bypassing 2FA, and ultimately build trust in digital banking systems.",
      ...
      },
      {
        ...
        status: "past",
        links: [
          { label: "Event", url: "https://www.wearedevelopers.com/world-congress" },
          { label: "Video", url: "https://www.wearedevelopers.com/en/videos/1584/the-irresistible-ux-the-psychology-of-brainwaves-and-clickbait" },
        ],
        description: [
          "This presentation dives into how understanding the human brain’s wiring can lead to more intuitive, engaging, and seamless user experiences. By leveraging cognitive biases, psychological principles, and neuroscience insights, we can design interfaces and workflows that feel natural to users, guide their behavior, and create habit-forming interactions. We'll explore how to reduce friction in digital products, keeping users engaged and making interactions almost instinctive.",
        ]
      },
      {
        ...
        status: "past",
        links: [
          { label: "Event", url: "https://ndcoslo.com/" },
          { label: "Video", url: "https://youtu.be/VXu-2Kv0DeM" },
        ],
        description: [
          "This presentation dives into how understanding the human brain’s wiring can lead to more intuitive, engaging, and seamless user experiences. By leveraging cognitive biases, psychological principles, and neuroscience insights, we can design interfaces and workflows that feel natural to users, guide their behavior, and create habit-forming interactions. We'll explore how to reduce friction in digital products, keeping users engaged and making interactions almost instinctive.",
        ]
    ...
    talks: [
      {
        ...
        status: "past",
        links: [
          { label: "Video", url: "https://gitnation.com/contents/tips-and-tricks-for-achieving-seamless-collaboration-between-developers-and-designers" },
        ],
        description: [
      ...
      },
      {
        ...
        status: "past",
        links: [
          { label: "Video", url: "https://youtu.be/po_Q8mj2uDY" },
        ],
        description: [
      ...
      },
      {
        ...
        status: "past",
        links: [
          { label: "Event", url: "https://www.meetup.com/uxgraz/events/302938490/" },
        ],
        description: [
      ...
      },
      {
        ...
        status: "past",
        links: [
          { label: "Video", url: "https://www.droidcon.com/2024/08/30/how-to-train-your-designer/" },
          { label: "Slides", url: "https://docs.google.com/presentation/d/1f_WAHD8p-zqT2cvLxqmVdVwM8MEjFzdqqagIGVpwc6w/edit#slide=id.g4dfce81f19_0_45" },
        ],
        description: [
          "I gave a talk about the collaboration between designers and developers. What are the best communication strategies? How can designers meet your needs, and can communication be improved? What are the best ways to integrate designers into your workflow for future collaborations?",
          ]
      },
    ],
  },
    ...
    talks: [
      {
        ...
        status: "past",
        links: [
          { label: "Video", url: "https://youtu.be/MqOLF98dKdE" },
          { label: "Slides", url: "https://docs.google.com/presentation/d/10YVYBIkyPLZcpG3xLoPD1xjdHbEa3nPMrcrVp-HYRW4/edit?usp=sharing" },
        ],
        description: [
    ...
    talks: [
      {
        ...
        status: "past",
        links: [
          { label: "Video", url: "https://youtu.be/gmjIcE97JC8" },
          { label: "Slides", url: "https://docs.google.com/presentation/d/1kBtedOYL1cyBXvDC-6Szos2e57XygOm5LbXCJll7pao/edit?usp=sharing" },
        ],
        description: [
